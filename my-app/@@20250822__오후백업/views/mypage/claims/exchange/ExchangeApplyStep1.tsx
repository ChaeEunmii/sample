...
import { ButtonArea, Button, TextList, Section } from '@/shared/ui';
import { DeliveryDetail } from '@widgets/order';
import { OrderTopInfo } from '@views/mypage/order/detail/components';
import { ClaimProdList } from '@views/mypage/claims/components';
...
export default function ExchangeApplyStep1() {
  ...
  // mock 데이터 가져오기
  const { topInfo, claimApplyItems, claimApplyMultiItems, deliveryDetail, deliveryDetailItems } =
    mockCommonOrder;
