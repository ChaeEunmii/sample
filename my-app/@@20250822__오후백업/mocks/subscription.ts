...
// ------------------- 상단 구독상세 정보 ------------------ //
export const mockSubscribeTopInfoData = {
  date: '20251225',
  orderNumber: '25122512345678',
...
export const mockTotalSubsScheduleItem = {
  ...
  paidAt: '2025.12.24 수요일',
  scheduledAt: '2025.12.24 수요일',
};
export const mockTotalSubsScheduleList = [
  { ...mockTotalSubsScheduleItem, id: 'schedule-01', status: 'round_unsubscribe' as const },
  { ...mockTotalSubsScheduleItem, id: 'schedule-02', status: 'round_active' as const },
  { ...mockTotalSubsScheduleItem, id: 'schedule-03', status: 'round_cancel' as const },
];
// 대기중만
