    ...
    >
      <div className={styles.voucher}>
        <VoucherCard
          ...
          bottomSlot={
            <>
              <VoucherDetailInfo items={mockVoucherDetailInfo} />
              {/* '방문예약' 사용가능 상태일경우 버튼노출 */}
              {isReservation && isAvailable && (
                <ButtonArea margin="1">
      ...
      <Collapse variant="section" marginTop="3">
