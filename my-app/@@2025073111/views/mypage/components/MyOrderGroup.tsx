...
import styles from './MyOrderGroup.module.scss';

/**
 * 배송 유형 기준으로 셀러별 주문 상품을 그룹화하여 노출하는 컴포넌트 (배열 데이터)
              ...
              <div className={styles.category}>
                {categorySlot ? (
                  ...
                  <Heading as="h2" size="5" weight="bold" className={styles.title}>
                    {categoryLabel || (deliveryData.deliveryType as DeliveryType)}
                  </Heading>
                )}
              </div>
            )}
