        ...
        sellers: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                status: 'unselectable', // 선택불가상태 테스트
...
export const mockRefundInfoData = {
  refundItems: [
    ...
    },
    {
      ...
      price: -123456700,
      fields: [
        { label: '추가 배송비', price: -123456700 },
        { label: '취소 위약금', price: -123456700 },
        { label: '차감 내용 3', price: -123456700 },
      ],
    },
  ],
  refundTotals: [
...
import type { OrderDeliveryData } from '@/views/mypage/components/MyOrderGroup';
// 배송지 샘플 (address.ts참고)
...
export const mockCommonOrder = {
  ...
  claimCompleteItem: mockClaimCompleteItemData, //클레임 신청완료 상품 1건노출
};
