...
import { BoardAccList } from '@/views/mypage/info/seller/components/BoardAccList';
import { EntryProcess } from '@views/mypage/info/seller/entry/info/EntryProcess';
...
import { mockSellerNotice } from '@views/mypage/info/seller/SellerDocs';
  ...
  return (
    ...
    >
      <Contents className={styles.layout}>
        ...
        {showContents && (
          <>
            <TitleBar type="docs" title="입점 절차 안내" />
