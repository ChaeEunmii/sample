...
import { PromoGiftType, renderGiftGroupTitle } from './GiftPackageInfo';
...
interface CrossDiscountInfoProps {
  /** 교차 할인 데이터 */
  crossData?: CrossDiscountInfoType;
  /** 사은품 혜택 데이터 */
  giftData?: PromoGiftType;
  /** 팝업 내부에서 사용되는지 여부 */
  useDialog?: boolean;
}

/** 유형별 텍스트 구하는 함수: CtaNoticeSection에서도 사용 */
export const getCrossDiscountText = (
...
export const CrossDiscountInfo = ({ crossData, giftData, useDialog }: CrossDiscountInfoProps) => {
  if (crossData) {
        ...
        <div className={styles.title}>
          ...
          <div>
            {data.value.map((value, index) => {
              /** 유형별 텍스트 개별 노출 */
              const [conditionText, benefitText] = getCrossDiscountText(data, value, useDialog);
              return (
