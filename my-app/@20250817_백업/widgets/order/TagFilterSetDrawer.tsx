...
export default function TagFilterSetDrawer({
  ...
  const [orderSelect, setOrderSelect] = useState<string>('all');
  const [reservationSelect, setReservationSelect] = useState<string>('all');
  ...
  return (
    ...
    >
      <div className={styles.top}>
        {!onlyCalendar && (
          <Input
            title={isReservation ? '매장명' : '주문한 상품명'}
            placeholder={isReservation ? '매장명으로 검색하세요' : '주문한 상품명으로 검색하세요'}
