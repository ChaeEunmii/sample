import { Image, Link, Heading, Text, Icon, Avatar } from '@shared/ui';
...
export interface CollectionCardProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  gem?: {
    isActive: boolean;
    onChange: (collectionId: string, isActive: boolean) => void;
  };
  /** 공개/비공개 여부 */
  isLock?: boolean;
  /** 카드 배경 색상 */
...
export const CollectionCard = ({
  ...
  return (
    <div className={clsx(styles.root, color !== 'white' && styles[color])} {...props}>
      {href ? (
