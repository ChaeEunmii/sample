...
import { Collapse, Heading, RadioGroup, Box, Stack, Input, Button, Switch, Text } from '@shared/ui';
      ...
      <div className={clsx(styles.usePoint, className)}>
        ...
        {!isChange && (
          <Stack type="field">
            ...
            />
            <Button variant="primary" size="large" disabled={isAllUsed} onClick={handleUseAllPoint}>
              전액 사용
            </Button>
          </Stack>
        )}
