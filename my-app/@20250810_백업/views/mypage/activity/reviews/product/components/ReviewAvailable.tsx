...
export const flagMap: Record<
  OrderReviewType,
  { label: string; color: 'green2' | 'gray' | 'white' }
> = {
  general: { label: '', color: 'gray' },
  monthly: { label: '한달사용', color: 'green2' },
  gift: { label: '받은 선물', color: 'green2' },
        ...
        <>
          <OrderItem
            ...
            orderTopSlot={(item) => {
              ...
              const { label, color } = flagMap[type];
