...
import { TextList, Image, Grid, IconButton, Icon, Text, Drawer } from '@shared/ui';
...
export const ImageUploader = ({
  ...
  const renderUploadButton = () => (
    <button
      ...
      onClick={
        isPickerDrawer
          ? () => setIsUploadMethodDrawer(true) // 드로어 열기
          : handleClickUpload // 기존 파일 찾기
      }
      className={styles.control}
    >
      <Icon size={isPickerDrawer ? 'large' : 'medium'} name={isPickerDrawer ? 'camera' : 'plus'} />
