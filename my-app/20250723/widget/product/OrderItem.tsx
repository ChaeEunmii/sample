...
export const OrderItem = ({
  ...
  const isSelectable = (item: OrderItemType) => {
    ...
    if (item.restock === false || item.delivery?.status === null) {
      return false;
    }
                ...
                <div className={clsx(styles.itemWrap)}>
                  <div className={styles.itemInfo}>
                    ...
                    >
                      ...
                      {item.status != null ? (
                        <div className={clsx(styles.thumb, styles.opacity)}>
                        ...
                        <Link
                          ...
                          className={clsx(
                            styles.thumb,
                            (item.restock === false || item.stock === 0 || item.stock <= 5) &&
                              styles.opacity
                          )}
                        >
                          {/* 썸네일 좌상단 플래그 */}
                    ...
                    <div className={styles.right}>
                      <div className={styles.detail}>
                        {/* 상단 슬롯 */}
                        {orderTopSlot && <div className={styles.topSlot}>{orderTopSlot(item)}</div>}
                        {item.status != null ? (
                        ...
                        {shouldRender && (
                          <ul className={styles.optionInfo}>
                      ...
                      {!isMultiDelivery && !isVerticalCenter && !hidePrice && (
                        <>
                          <div className={clsx(showOrderCount && styles.pricebox)}>
                            {!isOrderGift && !isVerticalCenter && !hidePrice && (
                              <ProdPrice
