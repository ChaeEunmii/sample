...
type ButtonSize = 'large' | 'medium' | 'small' | 'smaller' | 'xsmall';
  ...
  (
    ...
    return (
      ...
      >
        {iconOnly ? (
          <>
            <Icon name={iconOnly} size={setIconSize ? setIconSize : iconSize} />
            <span className="ncp-blind">{children}</span>
          </>
        ) : (
          <>
            {prefixIcon && <Icon name={prefixIcon} size={setIconSize ? setIconSize : iconSize} />}
            {children}
            {suffixIcon && <Icon name={suffixIcon} size={setIconSize ? setIconSize : iconSize} />}
          </>
        )}
      </button>
    );
