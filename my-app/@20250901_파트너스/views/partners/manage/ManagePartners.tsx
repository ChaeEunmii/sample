...
import ActivityTermsDialog from '@/views/mypage/partners/manage/components/ActivityTermsDialog';
    ...
    <Container showBack title="파트너스 활동 관리">
      <Contents>
        ...
        <ButtonArea margin="2">
          ...
          <Button variant="tertiary" onClick={() => setIsActivityTermsDialog(true)}>
            이용약관
          </Button>
        </ButtonArea>
