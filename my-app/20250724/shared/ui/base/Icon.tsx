...
export const ICON_NAMES = [
  ...
  'shop', 'homefeed', 'gem', 'mypage', 'pin', 'pinFilled', 'bell', 'bellOn', 'asterisk', 'map', 'gemPlus', 'camera', 'contact', 'top', 'link',
  ...
  'gemOn', 'gemOff', 'collectionOn', 'collectionOff', 'lock', 'time', 'highfiveOff', 'highfiveOn', 'hpoint', 'package', 'copy'
] as const;
