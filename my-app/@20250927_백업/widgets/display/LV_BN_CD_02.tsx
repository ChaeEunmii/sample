...
export interface LV_BN_CD_02Props extends DisplayProps {
  data: NotifyBannerProps[];
}

export const LV_BN_CD_02 = ({ title, subtitle, moreUrl, margin, data }: LV_BN_CD_02Props) => {
...
LV_BN_CD_02.displayName = 'LV_BN_CD_02';
