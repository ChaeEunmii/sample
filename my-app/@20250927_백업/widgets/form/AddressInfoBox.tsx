...
import { mockAddressItem, mockMaskingAddressItem } from '@/mocks/address';
...
interface AddressInfoBoxProps {
  ...
  /** 퍼블 전용 마스킹 임시 데이터 노출 여부(퍼블에서 화면 보여주기용. 개발시 삭제 부탁드립니다.) */
  isMasking?: boolean;
  /** 추가적인 클래스 이름 */
  className?: string;
}
...
export const AddressInfoBox = ({
  ...
  // 임시 데이터
  const address = isMasking ? mockMaskingAddressItem : mockAddressItem;
