  ...
  return (
    ...
    >
      {methods.map((method, index) => {
        const brandInfo = BRAND_INFO[method.brand] ?? BRAND_INFO.hyundai;
          ...
          >
            <div className={clsx(styles.card)} onClick={() => onCardClick(index)} role="button">
              ...
              >
                ...
                {(method.disabled ||
                  (method.brand === 'hyundaiDepartment' &&
                    (type === 'torder' || type === 'reservation'))) && (
                  <em
                    className={clsx(
                    ...
                    {method.disabledMessage ||
                      ...
                      (type === 'torder' || type === 'reservation') ? (
                        <>
                          백화점 카드는
                          <br />
                          {type === 'torder' ? '테이블오더 주문' : '매장 예약'} 시 사용할 수
                          없습니다.
                          <br />
                          양해부탁드립니다.
                        </>
