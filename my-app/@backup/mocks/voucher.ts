...
export const mockVoucherCards = [
  ...
  //사용 가능
  {
    ...
    status: 'available' as const,
    title: '위대한 뮤지션 100인전 전시 무료 입장권',
    subTitle: '브랜드명',
    infos: {
      // amount: 1,
      endDate: getToday(), //'오늘까지' 로 설정
    },
  },
  //사용 완료
  {
...
export const mockDisplayVoucher = mockVoucherCards.map((card) => ({
  id: card.id,
  image: card.image,
  title: card.title,
  infos: {
