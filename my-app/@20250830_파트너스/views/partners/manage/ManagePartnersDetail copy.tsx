...
import { Text, TextList, Box, InfoList, InfoItem, Flag, Table } from '@shared/ui';
          ...
          <Table className="ncp-mt-s">
            ...
            <Table.Head>
              <Table.Row>
                ...
                <Table.Cell colHeader>조회수</Table.Cell>
                <Table.Cell colHeader>주문수</Table.Cell>
                <Table.Cell colHeader>실적</Table.Cell>
              </Table.Row>
            </Table.Head>
            <Table.Body>
              <Table.Row>
                <Table.Cell>블랙 릴랙스드 롱 슬리브 셔츠</Table.Cell>
                <Table.Cell>999,999건</Table.Cell>
                <Table.Cell>999,999건</Table.Cell>
                <Table.Cell>0,000,000원</Table.Cell>
              </Table.Row>
            </Table.Body>
          </Table>
        </div>
