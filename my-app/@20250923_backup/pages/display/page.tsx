...
import { mockLiveDates, mockLiveCardList, mockLiveTiles } from '@mocks/display';
import {
  mockMeCardData,
  mockMeUsers,
  ...
  const renderComponent = (component: string | null) => {
    switch (component) {
      ...
      case 'HF_BN_CD_04':
        return (
          <>
            <HF_BN_CD_04 data={mockBannerList.slice(0, 1)} />
            <HF_BN_CD_04 data={mockBannerList} margin="6" />
          </>
        );
      case 'HF_BN_TX_02':
        return (
      ...
      case 'HF_CL_COL2_01':
        return <HF_CL_COL2_01 data={[...mockCollectionList, ...mockCollectionList]} />;

      case 'HF_LV_GD_01':
        return <HF_LV_GD_01 data={mockLiveTiles} />;

      case 'ML_ATTAG_BN_003':
        return (
          <>
            <ML_ATTAG_BN_003
              title="EXCLUSIVE OFFERS"
              ...
              data={[
                {
                  title: {
                    text: '브랜드명 최대 2줄 노출 후 말줄임 브랜드명 최대 2줄 노출 후 말줄임 브랜드명 최대 2줄 노출 후 말줄임 브랜드명 최대 2줄 노출 후 말줄임 ',
                  },
                  subtitle: {
                    text: '브랜드명 최대 2줄 노출 후 말줄임 브랜드명 최대 2줄 노출 후 말줄임 브랜드명 최대 2줄 노출 후 말줄임 브랜드명 최대 2줄 노출 후 말줄임 ',
                  },
