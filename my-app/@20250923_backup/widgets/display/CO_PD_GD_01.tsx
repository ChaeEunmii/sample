...
export interface CO_PD_GD_01Props extends DisplayProps {
  data: ProdCardItemProps[];
  rows: 1 | 2;
}

export const CO_PD_GD_01 = ({ margin, title, subtitle, moreUrl, data, rows }: CO_PD_GD_01Props) => {
  // 위시리스트 상태 관리
...
CO_PD_GD_01.displayName = 'CO_PD_GD_01';
