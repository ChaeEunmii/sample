...
export const MarqueeBanner = ({
  ...
  // 감싸는 태그 선택 (이미지 있으면 Link, 없으면 div)
  // const BannerTag: React.ElementType = hasImage ? Link : 'div';
  const BannerTag: React.ElementType = 'div';
  // 감싸는 태그 props
  const bannerProps = {
    className: clsx(styles.link, styles.inline, hasImage && styles.hasImg),
    ...(hasImage ? { href: href ?? '#' } : {}),
  };
  ...
  return (
    <div className={clsx(styles.root)} style={bannerStyle}>
