...
export const BannerTitle = ({
  ...
  return (
    <div className={clsx(styles.root, margin && styles.mt, className)}>
      {reverse ? (
        <>
          {hasSubTitle && (
            <Text
              ...
              style={{
                ...
                ...({
                  '--banner-text-truncate': subtitle.line,
          ...
          {hasTitle && (
            <Heading
              ...
              style={{
                ...
                ...({
                  '--banner-text-truncate': title.line,
                } as React.CSSProperties),
              }}
            >
              {title.text}
        ...
        <>
          {hasTitle && (
            <Heading
              className={clsx(
                styles.title,
                title.size && typeof title.size === 'string' && styles[`size${title.size}`]
              )}
              weight={title.weight}
              align={align}
              indent={indent}
              style={{
                ...
                ...({
                  '--banner-text-truncate': title.line,
                  ...(typeof title.size === 'number'
                    ? { '--banner-title-font-size': `var(--ncp-font-size-${title.size})` }
                    : {}),
                } as React.CSSProperties),
              }}
            >
