...
// 마이페이지 - H.Point Pay 이용약관들
export const HPOINTPAY_TERMS = [
  {
    id: 'hpointpay-terms-1',
    title: '전자금융거래 기본 약관',
    content: (
      <>
        ...
        <Text size="5" color="gray2" reading>
          이 약관은 전자지급결제대행서비스 및 결제대금예치서비스를 제공하는 토스페이먼츠
          주식회사(이하 ‘회사’라 합니다)와 이용자 사이의 전자금융거래에 관한 기본적인 사항을
        ...
        <Text size="5" color="gray2" reading>
          ...
          전자적 정보(신용카드번호를 포함한다), ‘전자서명법’상의 인증서, 금융기관 또는
          전자금융업자에 등록된 이용자번호, 이용자의 생체정보, 이상의 수단이나 정보를 사용하는데
        ...
        <Text size="5" color="gray2" reading>
          ...
          <br />② 회사는 이용자의 요청이 있는 경우 서면제공 방식 또는 전자문서의 전송방식에 의하여
          ...
          등록한 자신의 계좌에서 출금하여 원하는 계좌로 이체할 수 있는 실시간 송금 서비스를
          말합니다.
          <br />③ 가상계좌서비스: 이용자가 결제대금을 현금으로 결제하고자 경우 회사의
          전자결제시스템을 통하여 자동으로 이용자만의 고유한 일회용 계좌의 발급을 통하여 결제대금의
          지급이 이루어지는 서비스를 말합니다.
          <br />④ 기타: 회사가 제공하는 서비스로서 지급결제수단의 종류에 따라 ‘휴대폰
          결제대행서비스’, ‘KT전화(ARS,폰빌)결제대행서비스’, ‘상품권결제대행서비스’등이 있습니다.
          제5조 (결제대금예치서비스의 내용)
          ...
          <br />③ 회사는 이용자가 재화 등을 공급받은 날부터 3영업일이 지나도록 정당한 사유의 제시
          없이 그 공급받은 사실을 회사에 통보하지 아니하는 경우에는 이용자의 동의 없이
          ...
          위하여 본 약관과는 별도로 결제대금예치서비스이용약관을 제정할 수 있습니다. 제6조
          (접근매체의 선정, 관리 등)
        </Text>
      </>
    ),
  ...
  {
    id: 'hpointpay-terms-2',
    title: 'H.Point Pay 이용약관',
    content: <>약관내용</>,
  },
  {
    id: 'hpointpay-terms-3',
    title: '개인정보 수집 이용 동의',
    content: <>약관내용</>,
  },
  {
    id: 'hpointpay-terms-4',
    title: '개인정보 제3자 제공 동의',
    content: <>약관내용</>,
  },
  {
    id: 'hpointpay-terms-5',
    title: '오픈뱅킹 이용약관(은행)',
    content: <>약관내용</>,
  },
  {
    id: 'hpointpay-terms-6',
    title: '개인정보 제3자 제공 동의(은행)',
    content: <>약관내용</>,
  },
  {
    id: 'hpointpay-terms-7',
    title: '현대백화점 카드 확인을 위한 개인정보 수집 및 이용 동의',
    content: <>약관내용</>,
  },
];
