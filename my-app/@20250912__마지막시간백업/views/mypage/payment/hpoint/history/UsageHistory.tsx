...
import { HistoryItem } from '@/views/mypage/info/payment/hpoint/history/HistoryItem';
import type { HistoryData } from '@/views/mypage/info/payment/hpoint/history/HistoryItem';
