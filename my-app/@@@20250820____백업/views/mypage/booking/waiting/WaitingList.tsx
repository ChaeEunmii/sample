...
export const WaitingList = () => {
  ...
  return (
    <Container title="예약/오더" showBack>
      <Contents>
        {isRefresh && <div className={styles.refresh}>TBD</div>}
        {/* nav */}
        <BookingNav activeKey="waiting" />
        {/* 탭 & 태그필터 */}
        <TagFilter
        ...
        {myWatingData.length > 0 ? (
          ...
          <Empty
            title="내역 정보가 없어요"
            buttons={<Button variant="primary">웨이팅 하러 가기</Button>}
          />
        )}
      </Contents>
    </Container>
