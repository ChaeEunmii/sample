...
/* 마이페이지 - 주문/배송조회 (장바구니/주문서 화면의 OrderItem.tsx 컴퍼넌트 사용) 
...
export const mockOrderDetailItemsCase = [
  ...
  // 옴니결제 (해당 화면에 holidayOrder)
  {
    id: 'order-detail-omni',
    deliveryType: '택배배송',
    sellers: [
      {
        id: 'order-detail-omni-seller-01',
        seller: '팬트리1985',
        // arrival: '오늘밤 12시 전 도착',
        items: [
          {
            ...mockOrderItem,
            id: 'order-detail-omni-seller-01-item-01',
            delivery: {
              deliveryFee: 3000,
              feePolicy: 'freeOnly', //무료배송
            },
          ...
          {
            ...mockOrderItem,
            id: 'order-detail-omni-seller-01-item-02',
            delivery: {
              deliveryFee: 3000,
              feePolicy: 'freeOnly', //무료배송
            },
...
// 정기배송 상품
export const mockOrderDetailCaseSubscribe = [
  {
    id: 'order-detail-subscription',
    deliveryType: '택배배송',
    sellers: [
      {
        id: 'order-detail-subscription-seller-01',
        seller: '팬트리1985',
        // arrival: '오늘밤 12시 전 도착',
        items: [
          {
            id: 'order-detail-subscription-seller-01-item-01',
            href: '#',
            image: {
            ...
            orderStatus: {
              status: 'subscription_payment_completed' as const,
