...
import { prodReviewList, prodDoneList } from '@/mocks/myactivity';
import type { ProductData } from '@/views/mypage/activity/reviews/components/MyReviewItem';
...
export default function ProdReview() {
  ...
  const doneReviewData = isNoData ? [] : (prodDoneList as ProductData[]);
