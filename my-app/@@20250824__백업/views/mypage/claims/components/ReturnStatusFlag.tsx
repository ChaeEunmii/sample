...
const returnStatusMetaMap = {
  return_request_denied: { label: '반품접수불가', color: 'red2' },
  return_not_allowed: { label: '반품불가', color: 'red2' },
  product_collecting: { label: '상품회수중', color: 'gray4' },
  return_requested: { label: '반품접수', color: 'gray3' },
  refund_completed: { label: '환불완료', color: 'dark2' },
  return_confirmed: { label: '반품확정', color: 'dark2' },
} as const;
