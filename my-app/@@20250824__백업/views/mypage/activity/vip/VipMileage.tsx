...
export default function VipMileage() {
              ...
              <Stack className="ncp-w-full">
                ...
                <ButtonArea vertical margin="1" className="ncp-w-full">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      showAlert({
                        title: '현대백화점 APP으로 이동하시겠어요?',
                        message: `VIP 마일리지 적립 내역은 현대백화점 APP에서\n확인할 수 있습니다.`,
                        onConfirm: () => console.log('확인 클릭'),
                        showCancel: true,
                        labelProps: { confirm: '네', cancel: '아니요' },
                      });
                    }}
                  >
                    적립/사용 내역 확인하기
        ...
        <ConfirmInfo>
          <TextList
            data={[
              ...
              '현대백화점, NCP에서 구매한 금액은 상품군별로 적립되며, 현대아울렛에서 구매한 금액은 모두 패션 라이프 마일리지로 적립됩니다.',
