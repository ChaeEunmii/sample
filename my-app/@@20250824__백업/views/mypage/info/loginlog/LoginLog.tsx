        ...
        <ConfirmInfo>
          <TextList
            data={[
              ...
              'NCP에서는 최근 3개월 동ㅅ안 사용한 적 없는 기기에서 로그인 시 회원정보에 저장된 메일로 안내 서비스를 진행하고 있습니다.\n해당 기능은 실시간 차단 기능은 아니지만, 사용자 몰래 로그인한 경우 이메일을 통해 통지를 받을 수 있으니 이를 통해 사용중인 계정의 비밀번호를 변경하여 계정을 보호 하실 수 있습니다.',
            ]}
            variant="info"
          />
        </ConfirmInfo>
