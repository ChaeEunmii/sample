...
import { WaitingCancelDrawer } from '@/views/mypage/booking/waiting/WaitingCancelDrawer';
import { ReservationCancelDrawer } from '@/views/mypage/booking/reservation/ReservationCancelDrawer';
