...
export const TitleArea = ({
  ...
  // variant에 따른 Heading 설정
  const getHeadingProps = () => {
    const headingMap = {
      default: { as: 'h2', size: '8', weight: 'bold' },
      '1': { as: 'h2', size: '9', weight: 'bold' },
      '2': { as: 'h3', size: '6', weight: 'bold' },
    } as const;

    return variant in headingMap
      ? headingMap[variant as keyof typeof headingMap]
      : headingMap['default'];
  };
