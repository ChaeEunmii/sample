...
import { HPointHPointExpiringItem } from '@views/mypage/hpoint/component/HPointHPointExpiringItem';
import { mockHPointExpiringData } from '@mocks/mypage';
import styles from './HPointExpiring.module.scss';
          ...
          <>
            <ul className={styles.pointList}>
              {historyData.map((item) => (
                <HPointHPointExpiringItem key={item.id} data={item} />
              ))}
            </ul>
          </>
        ) : (
