...
export const MyClubDataMap = {
  beauty: {
    ...
    reviews: [
      {
        id: 'rsv1',
        productName: '비오템 핸드크림',
        options: '옵션1 / 옵션2',
        date: '2025.05.05',
        imageUrl: '/images/product/sample_1.png',
      },
    ],
    interest: [
      { label: '성별', content: '여성' },
...
export const clubOutdoor = {
  ...
  clothing: {
    title: '선호하는 의류(최대 3개)',
    data: [
      { label: '트레킹/하이킹', value: 'clothing1' },
      { label: '캠핑', value: 'clothing2' },
      { label: '피트니스', value: 'clothing3' },
      { label: '클라이밍', value: 'clothing4' },
      { label: '사이클', value: 'clothing5' },
      { label: '수영/서핑', value: 'clothing6' },
      { label: '일상', value: 'clothing7' },
    ],
  },
  winterOutdoor: {
    title: '겨울 아웃도어 활동 선호도',
    data: [
      { label: '스키', value: 'winter1' },
      { label: '스노우보드', value: 'winter2' },
      { label: '겨울 캠핑', value: 'winter3' },
      { label: '겨울 하이킹', value: 'winter4' },
      { label: '아이와 함께', value: 'winter5' },
    ],
  },
};
...
export const clubPet = {
  petCount: {
    ...
    data: [
      ...
      { label: '3마리', value: 'petCount2' },
      { label: '4마리', value: 'petCount2' },
      { label: '5마리', value: 'petCount2' },
    ],
  },
  petType: {
    title: '반려동물',
...
export const clubModern = {
  ...
  favCategory: {
    title: '관심 상품 카테고리(최대 3개)',
    data: [
      { label: '의류', value: 'favCategory1' },
      { label: '가방', value: 'favCategory2' },
      { label: '신발', value: 'favCategory2' },
      { label: '주얼리', value: 'favCategory2' },
      { label: 'ACC', value: 'favCategory2' },
    ],
  },
  favInfo: {
    title: '관심 상품 카테고리(최대 3개)',
