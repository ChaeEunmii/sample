...
import { mockBookData, mockNoticeList, mockCateFood, mockWarningtList } from '@/mocks/detail';
...
export const ProdNotice = () => {
  ...
  return (
    <>
      {/* 공지사항 */}
      <ProdTextList title="공지사항" list={notice} />
      ...
      {/* 유의사항 */}
      <ProdTextList title="유의사항" list={mockTexts} />
    </>
  );
};
