...
export const ProdDesc = () => {
  ...
  // 임시 데이터
  const mainThumb = 'https://placehold.co/600x400'; // 상품 대표 이미지
  const singleItemGuide = 'https://placehold.co/600x400'; // 단품 사이즈 가이드
  const koreanInfo = 'https://placehold.co/600x400'; // 한글표시사항
      ...
      >
        ...
        {descInputMethod === 'html' ? (
          ...
          mockDescTextList.map((desc, idx) => (
            <ProdTextList key={idx} title={desc.title} list={desc.list} />
          ))
        )}
        ...
        {singleItemGuide && (
          <div className={styles.boImages}>
            <Image src={'https://placehold.co/600x400'} alt="단품 사이즈 가이드" />
          </div>
        )}
        ...
        {koreanInfo && (
          <div className={styles.boImages}>
            <Image src={'https://placehold.co/600x400'} alt="한글표시사항" />
          </div>
        )}
