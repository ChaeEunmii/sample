...
export const mockProdShowroomItem = {
  ...mockProdGeneralItem,
  prodType: 'showroom',
  useChat: true, // 1:1채팅 YN
  isOnline: true, // 옴니결제+온라인 여부 (기본 false: 옴니결제만)
};
...
export const mockProdSpecialBrandItem = {
  ...
  brandLink: '#',
  brand: 'CHANEL',
  brandImage: '/images/detail/img_brand_chanel.svg',
  brandBottomImage: '/images/detail/img_brand_chanel2.png',
  colors: [
