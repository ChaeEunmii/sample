...
// ==================== 마이페이지 - 메인 ==================== //
// 상단 고객정보 샘플데이터
export const mockMainUserInfoData = {
  header: {
    id: 'user-id',
    name: '이*대',
    grade: 'fan' as const,
    membership: 'HiHi 멤버십 플러스',
    position: '임직원',
  },
  mespace: {
    href: '#',
    nickname: '오또리하우스',
    avatar: { src: '/images/dummy/@sample_people_01.png', alt: '트렌디 셀렉터' },
...
export const mainBenefitData = [
  {
    id: 'benefit_01',
    image: { src: '/images/mypage_benefit_01.png', alt: 'CLUB BEAUTY' },
    href: '#',
    title: 'CLUB BEAUTY',
