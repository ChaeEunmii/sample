...
import { MyOrderItemsList } from '@views/mypage/components/MyOrderItemsList';
import { OrderDeliveryData } from '@/views/mypage/components/MyOrderItems';
...
export const OrderProducts = ({
  ...
  return (
    ...
    >
      {/* 주문 상품 리스트 (MyOrderItemsList 사용시*/}
      {hasData && (
        <MyOrderItemsList
          data={data}
          viewType="detail"
