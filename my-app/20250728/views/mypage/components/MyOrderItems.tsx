...
/**
 * widget 공통 모듈: OrderItem 와 상태별 노출요소를 추가
 *
 * 마이페이지용
 * (배송타입명 + 그외 노출요소 + 그 안에 주문목록들) 구성 컴퍼넌트
 *
 * */
...
export function MyOrderItems({ data, viewType, onButtonClick, className }: MyOrderItemsProps) {
  return (
