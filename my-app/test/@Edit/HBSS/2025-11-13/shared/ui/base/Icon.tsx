...
export const ICON_NAMES = [
  ...
  'back', 'chat', 'menu', 'setting', 'share', 'home', 'qrcode', 'qrcode2', 'global', 'more', 'more2',
  'shop', 'shop2', 'homefeed', 'gem', 'mypage', 'pin', 'pinFilled', 'pinBg', 'bell', 'bellOn', 'asterisk', 'map', 'gemPlus', 'camera', 'contact', 'top', 'link',
  ...
  'gemOn', 'gemOff', 'collectionOn', 'collectionOff', 'lock', 'time', 'highfiveOff', 'highfiveOn', 'hpoint', 'package', 'copy', 'copy2', 'caution',
  'reply', 'replyFill', 'review', 'reviewFill', 'bookmark', 'bookmarkFill', 'vote', 'voteFill',
  'dash', 'edit', 'openNew', 'live', 'waiting', 'reservation', 'grade1', 'grade2', 'grade3', 'grade4', 'sorting', 'swap', 'caretRight',
  'list', 'event2', 'heydi', 'club', 'flight', 'hotel', 'breakfast', 'transfer', 'tripInsurance', 'calendar', 'user', 'write', 'send', 'complete', 'hCircle', 'flightTakeoff', 'flightLanding', 'airplain',
  'folderBg', 'packageOpen'
] as const;
