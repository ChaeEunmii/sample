...
import { DeliveryStep } from './SpecialStep';
import { HbssStepTitle, DateSelectField, TitleWithInfoAddr } from '@views/hbss/components';
import { ThanksProdListDialog } from '@views/hbss/special/components/ThanksProdListDialog';
import styles from './SpecialStep.module.scss';

export default function SpecialStep1() {
  const [isThanksProdListDialog, setIsThanksProdListDialog] = useState(false); // 감사 상품 목록 (L)
          ...
          <FormItem
            ...
            side={
              <TextButton
                ...
                variant="underline"
                color="gray3"
                onClick={() => setIsThanksProdListDialog(true)}
              >
                자세히 보기
              </TextButton>
            }
