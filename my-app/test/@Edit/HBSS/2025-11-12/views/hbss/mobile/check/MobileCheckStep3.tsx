...
import { Steps, ButtonArea, Button, Text, Checkbox } from '@shared/ui';
    ...
    <Container showBack title="">
      <Contents className={styles.layout}>
        ...
        <TitleWithInfoStack gap="3">
          ...
          <TitleWithInfo title="배송 예정일" content="2025년 12월 25일 목요일" />
          <TitleWithInfo
            title="배송지 일괄지정 서비스 안내 (선택)"
            content={
              <Text size="4" color="gray2" weight="medium" reading>
