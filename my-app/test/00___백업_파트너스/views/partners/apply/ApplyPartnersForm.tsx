...
import styles from './ApplyPartnersForm.module.scss';
...
export default function ApplyPartnersForm() {
  const [isPartnersTermsAgreeDrawer, setIsPartnersTermsAgreeDrawer] = useState(false); // 이용약관 (D)
  ...
  return (
    <Container showBack title="파트너스 신청하기">
      <Contents>
        <TitleBar type="docs" title="파트너스 이용 약관 동의" level="1" className="ncp-mt-s" />
        {/* 동의 체크 */}
          ...
          <Checkbox
            label={
              <>
                ...
                <IconButton name="arrowRight" onClick={() => setIsPartnersTermsAgreeDrawer(true)}>
                  약관 상세 열기
                </IconButton>
              </>
            }
