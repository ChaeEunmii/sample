...
export const clubThumbTabs = [
  {
    ...
    id: "beauty",
    label: "클럽뷰티",
    thumb: "/images/club/club_tab_icon_01.png",
  },
  {
    href: "#moms",
    id: "moms",
    label: "클럽맘스",
    thumb: "/images/club/club_tab_icon_02.png",
  },
  {
    href: "#outdoor",
    id: "outdoor",
  ...
  },
  {
    ...
    id: "pet",
    label: "클럽펫",
    thumb: "/images/club/club_tab_icon_04.png",
  },
  {
    href: "#healthy",
    id: "healthy",
  ...
  },
  {
    ...
    id: "modern",
    label: "클럽모던",
    thumb: "/images/club/club_tab_icon_06.png",
  },
  {
    href: "#ezwel",
    id: "ezwel",
    label: "클럽이지웰",
    thumb: "/images/club/club_tab_icon_07.png",
  },
  {
    href: "#friends",
    id: "friends",
...
export const MyClubDataMap = {
  ...
  moms: {
    ...
    // reviews: mockClubReviews,
    reviews: [], //'작성가능한 리뷰 목록없음'을 보여주기 위함
    interest: [
      [
  ...
  ezwel: {
    // '클럽이지웰'은 reward(추가적립), reviews(작성가능한리뷰), interest(관심정보) 없음.
    id: "ezwel",
    benefits: {
      // signup: [
      //   { label: '15% 할인 쿠폰', content: 2 },
  ...
  friends: {
    // '클럽프렌즈'은 reward(추가적립), reviews(작성가능한리뷰), interest(관심정보) 없음.
    id: "friends",
    benefits: {
      // signup: [
      //   { label: '15% 할인 쿠폰', content: 2 },
...
export const dogOptions = [
  { value: "dog-01", label: "골든 리트리버" },
  { value: "dog-02", label: "닥스훈트" },
  { value: "dog-03", label: "몰티즈" },
  { value: "dog-04", label: "베들링턴 테리어" },
  { value: "dog-05", label: "보더 콜리" },
  { value: "dog-06", label: "비글" },
  { value: "dog-07", label: "비숑 프리제" },
  { value: "dog-08", label: "시츄" },
  { value: "dog-09", label: "요크셔 테리어" },
  { value: "dog-10", label: "웰시코기" },
  { value: "dog-11", label: "치와와" },
  { value: "dog-12", label: "진돗개" },
  { value: "dog-13", label: "토이푸들" },
  { value: "dog-14", label: "파피용" },
  { value: "dog-15", label: "포메라니안" },
  { value: "dog-16", label: "프렌치 불도그" },
  { value: "write", label: "직접입력" },
];
// 고양이 품종 선택 옵션
export const catOptions = [
  { value: "cat-01", label: "노르웨이숲고양이" },
  { value: "cat-02", label: "렉돌" },
  { value: "cat-03", label: "러시안블루" },
  { value: "cat-04", label: "먼치킨" },
  { value: "cat-05", label: "벵갈" },
  { value: "cat-06", label: "브리티시쇼트헤어" },
  { value: "cat-07", label: "브리티시롱헤어" },
  { value: "cat-08", label: "샴" },
  { value: "cat-09", label: "스코티시폴드" },
  { value: "cat-10", label: "스핑크스" },
  { value: "cat-11", label: "아메리칸쇼트헤어" },
  { value: "cat-12", label: "아비시니안" },
  { value: "cat-13", label: "코리안쇼트헤어" },
  { value: "cat-14", label: "터키시앙고라" },
  { value: "cat-15", label: "페르시안" },
  { value: "write", label: "직접입력" },
];
