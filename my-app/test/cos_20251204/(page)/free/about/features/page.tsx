                  ...
                  <div className="column relative col-span-12 w-full h-full lg:col-span-5  lg:col-start-2 lg:col-end-7 ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-womens-winter-capsule-wardrobe.html"
                  ...
                  <div className="column relative col-span-12 w-full h-full lg:col-span-5   ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-mens-winter-capsule-wardrobe.html"
                  ...
                  <div className="column relative col-span-12 w-full h-full lg:col-span-4  lg:col-start-5 lg:col-end-9 ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/people/perspectives-rosie-huntington-whiteley.html"
                  ...
                  <div className="column relative col-span-8 w-full h-full lg:col-span-4  lg:col-start-3 lg:col-end-7 ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-womens-aw25-runway-collection.html"
                  ...
                  <div className="column relative col-span-8 w-full h-full lg:col-span-4   ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/autumn-winter-colour-palette.html"
                  ...
                  <div className="column relative col-span-8 w-full h-full lg:col-span-4  lg:col-start-3 lg:col-end-7 ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-cashmere-clothing-edit.html"
                  ...
                  <div className="column relative col-span-8 w-full h-full lg:col-span-4   ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-cashmere-clothing-menswear-edit.html"
                  ...
                  <div className="column relative col-span-6 w-full h-full lg:col-span-3  lg:col-start-4 lg:col-end-7 ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://cos.com/ko-kr/features/stories/the-womens-outerwear-collection.html"
                  ...
                  <div className="column relative col-span-6 w-full h-full lg:col-span-3   ">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://cos.com/ko-kr/features/stories/the-mens-outerwear-collection.html"
                  ...
                  <div className="column relative col-span-8 w-full h-full lg:col-span-4  lg:col-start-3 lg:col-end-7 ">
                    <div className="m-free-tile lg:px-0 " style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-womens-autumn-capsule-wardrobe-2025.html"
                  ...
                  <div className="column relative col-span-8 w-full h-full lg:col-span-4">
                    <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                      <picture
                        ...
                        data-component="APicture"
                        className="a-picture"
                        data-link="https://www.cos.com/ko-kr/features/stories/the-mens-autumn-essentials-wardrobe-2025.html"
                    ...
                    <div className="column relative col-span-6 w-full h-full lg:ml-[15%] lg:col-span-3  lg:col-start-2 lg:col-end-5 ">
                      <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                        <picture
                          ...
                          data-component="APicture"
                          className="a-picture"
                          data-link="https://www.cos.com/ko-kr/features/stories.html"
                    ...
                    <div className="column relative col-span-6 w-full h-full lg:ml-[15%] lg:col-span-3   ">
                      <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                        <picture
                          ...
                          data-component="APicture"
                          className="a-picture"
                          data-link="https://www.cos.com/ko-kr/features/people.html"
                    ...
                    <div className="column relative col-span-6 w-full h-full lg:ml-[15%] lg:col-span-3   ">
                      <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                        <picture
                          ...
                          data-component="APicture"
                          className="a-picture"
                          data-link="https://www.cos.com/ko-kr/features/places.html"
