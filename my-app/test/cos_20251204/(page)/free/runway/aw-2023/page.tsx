        ...
        <div className="content-section">
          ...
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row u-full-width">
            ...
            <div className="o-text-block u-float-center ">
              ...
              <div className="preamble-section">
                <p className="a-paragraph " style={{ cursor: 'default' }}>
                  서로 다른 요소를 믹스해 재정의한 컬렉션을 만나보세요. 유기적인 형태와 기하학적인 형태, 광택 있는
                  질감과 매트한 질감, 전통적인 요소와 혁신적인 요소를 결합했습니다.
                </p>
              </div>
            </div>
            {/*// o-text-block */}
          ...
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row u-full-width">
            ...
            <div className="o-text-block u-float-center ">
              ...
              <div className="preamble-section">
                <p className="a-paragraph " style={{ cursor: 'default' }}>
                  2023 가을 겨울 런웨이를 방문해 자리를 빛낸 게스트. 조디 터너 스미스, 조슈아 잭슨, 수키 워터하우스,
                  카밀 로우, 에반 목, 하트 에반젤리스타와 하리 네프, 그리고 캠페인 모델 켈렐라와 커티스 하딩까지
                  함께했습니다.
                </p>
              </div>
            </div>
