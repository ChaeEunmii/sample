...
export const mockDetailList = [
  ...
  {
    id: 'order-detail-tod-02',
    deliveryType: '새벽/당일배송',
    sellers: [
      {
        id: 'order-detail-tod-02-seller-01',
        seller: '현대백화점',
        arrival: '오늘밤 12시 전 도착',
        items: [
          {
            ...mockOrderItem,
            id: 'order-detail-tod-02-seller-01-item-01',
            delivery: {
              deliveryFee: 3000,
    ...
    sellers: [
      {
        ...
        items: [
          ...
          {
            ...mockOrderItem,
            id: 'order-detail-tb-01-seller-01-item-03',
            delivery: {
              deliveryFee: 3000,
              feePolicy: 'freeOnly',
            },
    ...
    sellers: [
      {
        ...
        items: [
          {
            ...mockOrderItem,
            id: 'order-detail-culture-seller-01-item-00',
            brand: '',
            ...
            orderStatus: {
              status: 'order_completed',
              date: '2025-10-25T12:34:56',
              orderCase: 'culture_cancelable_default' as const,
            },
          },
          {
            ...mockOrderItem,
...
// 기프티콘
export const mockOrderDetailCaseGifticon = [
  {
    id: 'order-detail-gifti-01',
    deliveryType: '택배배송',
    sellers: [
      {
        id: 'order-detail-gifti-01-seller-01',
        // seller: 'e슈퍼마켓',
        items: [
          {
            ...mockOrderItem,
            id: 'order-detail-gifti-01-seller-01-item-01',
            price: {
              current: 0,
              // original: 23456780,
            },
...
// 투홈
export const mockPaymentApprovalData2 = {
  paymentData: [
    {
      label: 'H.Point Pay',
      price: 123456700000,
...
// 결제정보_투홈
export const mockToHomeExtraPayment = {
  variant: 'extra_payment' as const,
  items: [
...
// 결제정보_투홈_테이블오더
export const mockToHomeTorderPayment = {
  variant: 'extra_payment' as const,
  items: [
...
export const mockDeliveryCase2 = [
  {
    name: '김*대',
    phone: '010-****-5678',
    addPhone: '010-****-5978',
    message: `안전하고 빠른 배송 부탁드립니다. 기다리고 있어요.\n빨리 왔으면 좋겠어요!`,
  },
];
...
export const mockCommonOrder = {
  ...
  orderItems: mockDetailList as OrderDeliveryData[], // 상세에서 사용하는 목록
  deliveryDetail: mockDeliveryCase[0],
  deliveryDetailItems: mockDeliveryCase,
  deliveryAddress: mockDeliveryCase2,
...
export const mockToHomeTorderDetailList = [
  // 테이블오더
  {
    id: 'order-detail-torder-02',
    deliveryType: '테이블오더',
    sellers: [
      {
        id: 'order-detail-torder-01-seller-01',
        // seller: '판매자명',
        items: [
          {
            ...mockTorderItem,
            id: 'order-detail-torder-01-seller-01-item-01',
            orderOptions: [],
            orderStatus: {
              status: 'order_completed',
              date: '2025-10-25T12:34:56',
          ...
          {
            ...mockTorderItem,
            id: 'order-detail-torder-01-seller-01-item-02',
            orderStatus: {
              status: 'order_completed',
              date: '2025-10-25T12:34:56',
            },
          ...
          {
            ...mockTorderItem,
            id: 'order-detail-torder-01-seller-01-item-03',
            tOrderDetail: mockTorderItemDetails,
            orderStatus: {
              status: 'order_completed',
              date: '2025-10-25T12:34:56',
