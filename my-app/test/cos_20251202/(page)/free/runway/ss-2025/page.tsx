          ...
          <div className=" relative" style={{ maxWidth: 'unset' }}>
            ...
            <div className="grid grid-cols-12 " style={{ width: '100%' }}>
              ...
              <div className="col-span-12 relative lg:col-span-6 flex  overflow-hidden w-full slider-container pointer-events-auto ">
                <div
                  className="slides-left_527869 w-full"
                  style={{
                ...
                >
                  <div
                    className="slide_left_527869 flex justify-center items-center  min-w-full min-w-screen lg:min-w-[50vw] venCpn-image"
                  ...
                  >
                    ...
                    <div
                      ...
                      className="bg-clip-text text-main cursor-pointer flex items-center hover:underline next-button-left_527869 font_small_l_regular text-3.25"
                ...
                <div
                  ...
                  className="bg-clip-text text-main-inverted mix-blend-difference pagination pagination-left_527869 flex justify-center gap-1  "
                >
