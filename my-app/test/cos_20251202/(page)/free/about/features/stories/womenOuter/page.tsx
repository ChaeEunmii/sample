...
import { ProductListing } from '@views/main/components';

import { Products } from '@views/product/shop/ShopData';
...
export default function Page() {
  return (
    <>
      ...
      <p className="txtc">&nbsp;</p>
      <div className="free-grid gap-16">
        <div className="col-12 lg-col-start-3 lg-col-8">
          <ProductListing
