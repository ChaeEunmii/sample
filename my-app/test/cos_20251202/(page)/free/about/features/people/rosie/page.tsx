...
export const metadata: Metadata = {
  title: '모델 로지 헌팅턴 휘틀리의 순간 속 시선 - COS KR',
};
    ...
    <FreeHtml>
      ...
      <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row u-full-width">
        <div className=" relative" style={{ maxWidth: 'unset' }}>
          ...
          <div
            className="container-645233 flex flex-col w-full lg:pb-30 pb-20  gap-20 lg:gap-30 manual-cpnt"
            style={{ paddingTop: 36 }}
          >
            <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row one-column-row  load-more-645233 ">
              {/* o-grid-controller */}
                ...
                <div className="column relative col-span-12 w-full h-full lg:col-span-5  lg:col-start-4 lg:col-end-9 lg:ml-[10%] ">
                  <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                    <picture
                      ...
                      className="a-picture"
                      data-component-id="9b8ff4dc-4f67-4489-8f28-fa41624993f3"
                    >
                      <img
                        loading="lazy"
                        className="a-image initial loaded"
                        data-src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2947540020251013085731.jpg"
                        src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2947540020251013085731.jpg"
        ...
        <div className="col-span-full col-start-1 lg:col-start-7 lg:col-span-3">
          <div className="[&_a]:underline [&_button]:underline lg:font_s_regular">
            <p className="">
              <span>
                {' '}
                9월의 뉴욕은 특별한 매력을 지니고 있습니다. 패션 브랜드가 거리를 가득 채우면, 도시 고유의 에너지는
                새로운 리듬으로 움직이기 시작합니다. 로지 헌팅턴 휘틀리 이 감정을 누구보다 잘 알고 있습니다. 16세에
                모델로 데뷔한 로지는, 런웨이를 누비고, 캐스팅과 피팅으로 맨해튼을 오가며, 무대 뒤의 긴장감과 파티의
                열기를 모두 경험해왔습니다.
                <br />
                <br />
                이제 38세가 된 로지는 모델, 배우, 그리고 사업가로 활약하며 영역을 넓혀왔습니다. 패션과 뷰티 등 로지는
                화보, 그 이상의 경력을 쌓아왔으며, 다음 세대 모델들에게도 영감을 주는 롤모델입니다.
              </span>
            </p>
          </div>
        </div>
      ...
      <div className="o-spacing" />
      <div className="container-644302 flex flex-col gap-20 lg:gap-30 lg:px-5 w-full lg:pb-30 pb-20 manual-cpnt">
        <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row two-column-row load-more-644302 ">
          {/* o-grid-controller */}
            ...
            <div className="column relative col-span-8 w-full h-full lg:col-span-4  lg:col-start-3 lg:col-end-7 ">
              <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                <picture
                  ...
                  data-component="APicture"
                  className="a-picture"
                  data-component-id="8fdb2530-fdc5-476e-b995-45a0262e4512"
                >
                  <img
                    loading="lazy"
                    className="a-image loaded"
                    data-src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2947540020251002155549.jpg"
                    src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2947540020251002155549.jpg"
            ...
            <div className="column relative col-span-8 w-full h-full lg:col-span-4">
              <div className="m-free-tile lg:px-0" style={{ cursor: 'default' }}>
                <picture
                  ...
                  data-component="APicture"
                  className="a-picture"
                  data-component-id="bd619887-9ccb-458c-b5bc-06e62f3ae9df"
                >
                  <img
                    loading="lazy"
                    className="a-image loaded"
                    data-src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2947541020251002155555.jpg"
                    src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2947541020251002155555.jpg"
                    style={{ objectFit: 'cover', aspectRatio: '2/3' }}
                    data-was-processed="true"
                  />
                </picture>
      ...
      >
        <div className="col-span-full col-start-1 lg:col-start-7 lg:col-span-3">
          <div className="[&_a]:underline [&_button]:underline lg:font_s_regular">
            <p className="">
              <span>
                스타일 감각은 경험과 사람들을 통해 자연스럽게 다듬어졌고, &nbsp;곧 문화적인 영향력으로 이어졌습니다.
                시간이 흐르며 로지는 성장했지만, 스타일에 대한 그녀의 철학은 일관되어 왔습니다. 영국 데번의 전원에서
                보낸 유년 시절부터, 뉴욕에서의 모델 시절, LA에서 두 아이의 엄마가 된 이후, 그리고 지금은 런던에서의
                새로운 일상에 이르기까지. <br /> <br />
                COS 2025 가을 겨울 런웨이를 향해 달리는 뉴욕 택시 안에서 로지를 만나, 전 세계 도시의 에너지와
                크리에이티브, 그리고 스타일에 대한 로지의 생각에 대해 인터뷰를 나누었습니다.
              </span>
            </p>
            <p className="">
              <span>&nbsp;</span>
