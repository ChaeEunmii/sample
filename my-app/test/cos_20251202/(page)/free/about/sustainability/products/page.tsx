                      ...
                      <div className="freetile parbase section must-margin-0">
                        <div className="m-free-tile two-cols " style={{ clear: 'both', backgroundColor: '#ffffff' }}>
                          <picture
                            ...
                            className="a-picture"
                            data-component-id="9c32c77f-c449-4e90-86a2-9cc593067ede"
                          >
                            <img
                              src="https://image.thehyundai.com/cos/hyundai/2025/8/27/제품 LP/1번.jpg"
                              style={{ width: '100%' }}
                            />
                          </picture>
                        </div>
                        ...
                        <div className="m-free-tile two-cols" style={{ clear: 'both', backgroundColor: '#ffffff' }}>
                          <div className="richTextSpan">
                            <div className="o-blog-text is-richtext" style={{ width: '100%', textAlign: 'left' }}>
                              ...
                              >
                                COS 컬렉션은 우수한 퀄리티와 오래도록 지속되는 디자인을 바탕으로 제작됩니다. 섬유와
                                촉감을 고려하여 소재를 선택하며, 특히 소재의 특성, 원사 수, 섬유 길이와 마감 정도에 따라
                                사용합니다. <br />
                                <br />
                                COS 디자인 팀은 캐시미어, 코튼, 울, 리넨과 천연 소재를 컬렉션에서 우선적으로 사용합니다.
                                또한 동물 복지 및 토지 관리 관행을 독립적으로 인증하는 Textile Exchange의 동물 복지
                                표준에 의해 인증된 오가닉, 리사이클 소재까지, 고품질 소재의 소싱에 중점을 두고 있습니다.
                                <br />
                                <br />
                              </p>
                            </div>
                    ...
                    >
                      <div className="cta-section">
                        <a
                          ...
                          href="/free/about/sustainability/products/materials"
                        ...
                        <a className="fitguide_btn" href="/free/about/care">
                          제품 관리 가이드
                          <div className="m-double-button" style={{ textAlign: 'left' }}>
                            <div className="cta-wrap">
                              <i className="arrow right" role="img" />
                  ...
                  <div className="o-blog-text is-richtext m_align_center">
                    ...
                    >
                      <img
                        ...
                        src="https://image.thehyundai.com/cos/hyundai/2025/8/27/제품 LP/2번 소재.jpg"
                    ...
                    <p
                      ...
                      className="article-headline-sub"
                    >
                      우수한 퀄리티와 오래도록 지속되는 디자인을 기반으로 한 컬렉션의 소재에 대해 자세히 알아보세요.{' '}
                    </p>
                    <div className="cta-wrapper noComma" style={{ fontSize: 16, marginBottom: 0 }}>
                      <a
                        target="_self"
                      ...
                      >
                        더 보기{' '}
                        <div className="cta-wrap" style={{ display: 'inline-block' }}>
                          <i className="arrow right" role="img" />
                        </div>
                        <br />
                        <br />
                      ...
                      <div className="column leftcolum" style={{}}>
                        <div className="m-free-tile" style={{ cursor: 'default' }}>
                          ...
                          >
                            <img
                              className="a-image loaded initial"
                              src="https://image.thehyundai.com/cos/hyundai/2025/8/27/제품 LP/4번 제품 관리 가이드.jpg"
                              data-was-processed="true"
                            />{' '}
                          </a>
                          <div className="headline-preamble-wrapper">
                            ...
                            <p className="a-label js-a-label " style={{ cursor: 'default' }}>
                              COS 컬렉션은 우수한 퀄리티를 중점에 두고 디자인되었습니다. 캐시미어 관리부터 레더
                              관리까지, 오래도록 아이템을 보관할 수 있는 방법을 관리 가이드에서 확인해 보세요.
                            </p>
                          </div>
