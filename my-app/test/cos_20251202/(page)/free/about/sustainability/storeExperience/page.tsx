                  ...
                  <div className="scrollable-content">
                      ...
                      <div className="freetile parbase section must-margin-0">
                        <div className="m-free-tile two-cols " style={{ clear: 'both', backgroundColor: '#ffffff' }}>
                          <picture
                            ...
                            className="a-picture"
                            data-component-id="5a1fea3b-7bd5-4a61-a84b-8760b5f1dbfe"
                          >
                            <img
                              src="https://image.thehyundai.com/cos/hyundai/2025/8/27/스토어 경험 LP/COS_750X1125.jpg"
                              style={{ width: '100%' }}
                            />
                          </picture>
                        </div>
                        ...
                        <div className="m-free-tile two-cols" style={{ clear: 'both', backgroundColor: '#ffffff' }}>
                          <div className="richTextSpan">
                            <div className="o-blog-text is-richtext" style={{ width: '100%', textAlign: 'left' }}>
                              ...
                              >
                                전문적인 장인 정신, 혁신, 소재에 중점을 둔 스토어과 패키징은 COS의 세계에서 없어서는 안
                                될 중요한 부분입니다. 향상된 쇼핑 경험을 제공하여 모던한 감각을 반영하는 방식으로
                                컬렉션을 탐색하고 상호 작용할 수 있습니다.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    >
                      <div className="cta-section">
                        ...
                        <a className="fitguide_btn" href="/free/about/sustainability/planet/packaging">
                          COS 패키징
                          <div className="m-double-button" style={{ textAlign: 'left' }}>
                            <div className="cta-wrap">
                              <i className="arrow right" role="img" />
                ...
                <div className="magazine-type o-grid-controller u-clearfix is-stacked-on-mobile is-three-cols">
                  ...
                  <div className="content" style={{ overflow: 'hidden' }}>
                    <div className="scrollable-content magazine-2021">
                      <div className="column leftcolum fullrectangle">
                        <div className="m-free-tile" style={{ cursor: 'default' }}>
                          <div className="headline-preamble-wrapper">
                            ...
                            <img
                              ...
                              src="https://image.thehyundai.com/cos/hyundai/2025/8/27/스토어 경험 LP/COS_1920X1200.jpg"
                              data-was-processed="true"
                            />
                            <p className="a-label js-a-label " style={{ cursor: 'default' }}>
                              인테리어 콘셉트 전반에 걸쳐 사용된 소재에 대해 자세히 알아보세요.{' '}
                            </p>
                          </div>
                      ...
                      <div className="column leftcolum" style={{}}>
                        <div className="m-free-tile" style={{ cursor: 'default' }}>
                          ...
                          <img
                            className="a-image loaded initial"
                            style={{ marginBottom: 15 }}
                            src="https://image.thehyundai.com/cos/hyundai/2025/3/5/000918 COS 06K MRS low-res.jpg"
                            data-was-processed="true"
                          />
                          <div className="headline-preamble-wrapper">
                            <p className="a-label js-a-label " style={{ cursor: 'default' }}>
                              시그니처 COS 캐리어 백은 100% 종이로 제작되어 재활용이 가능하도록 설계되었습니다.
                            </p>
                          </div>
                          <div className="cta-wrapper noComma">
                            <a
