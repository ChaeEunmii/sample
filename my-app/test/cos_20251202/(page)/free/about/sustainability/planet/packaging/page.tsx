...
export const metadata: Metadata = {
  title: '디자인과 제작 과정 - COS 패키징',
};

export default function Page() {
  return (
    <FreeHtml>
      <div className="content-section cos-packaging">
                      ...
                      <div className="freetile parbase section must-margin-0">
                        <div className="m-free-tile two-cols " style={{ clear: 'both', backgroundColor: '#ffffff' }}>
                          <picture
                            ...
                            className="a-picture"
                            data-component-id="473b4ec9-4104-42da-a5cb-266772eba3a5"
                          >
                            <img
                              src="https://image.thehyundai.com/cos/hyundai/2024/9/2/000918 COS 06K MRS low-res-2.jpg"
                              style={{ width: '100%' }}
                            />
                          </picture>
                        </div>
                        ...
                        <div className="m-free-tile two-cols" style={{ clear: 'both', backgroundColor: '#ffffff' }}>
                          <div className="richTextSpan">
                            <div className="o-blog-text is-richtext" style={{ width: '100%', textAlign: 'left' }}>
                              ...
                              >
                                제품을 포장하는 방식은 COS 브랜드 경험에서 중요한 부분을 차지해 왔습니다. 그렇지만, 이를
                                제작하기 위해서는 귀중한 자원이 필요하다는 것을 알고 있습니다. <br />
                                <br />
                                캐리어의 시그니처 COS 캐리어 백은 100% 종이로 제작되어 재활용이 가능하도록
                                설계되었습니다. 손잡이까지 FSC 인증 종이로 제작되어 사용 후 가방 전체를 재활용 수거함에
                                버리기만 하면 됩니다. 스토어에서 제품을 포장할 때 사용하는 티슈 페이퍼도 재활용이
                                가능하며, 50% 리사이클 페이퍼로 만들어집니다.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      >
                        <a
                          ...
                          href="/free/about/sustainability/planet/buildings"
                          style={{
                      ...
                      <div className="m-free-tile" style={{ cursor: 'default' }}>
                        ...
                        >
                          <img
                            ...
                            src="https://image.thehyundai.com/cos/hyundai/2024/9/2/Photo7.jpg"
                    ...
                    <div className="column">
                      <div className="m-free-tile" style={{ cursor: 'default' }}>
                        ...
                        >
                          <img
                            className="a-image loaded initial"
                            src="https://image.thehyundai.com/cos/hyundai/2024/9/2/Photo8.jpg"
                            data-was-processed="true"
                          />{' '}
                        </a>
                      </div>
              ...
              <div className="richTextSpan">
                <div className="o-blog-text is-richtext m_align_center">
                  ...
                  <p className="article-headline-sub">
                    소비자들이 스토어에서 접할 수 있는 아이템은 지속 가능한 방식으로 제작되었습니다. 예를 들어 수트
                    케이스는 100% 리사이클 폴리프로필렌 소재를 사용했으며, 부자재가 없어 쉽게 재활용할 수 있도록
                    제작되었습니다. 그리고 기프트 카드는 혁신적인 리사이클 페이퍼로 제작되었습니다.
                    <br />
                    <br />
                    구매 제품에 대한 자세한 정보를 확인할 수 있도록 라벨과 행택이 포함되어 있습니다. 주요 행택은 100%
                    리사이클 페이퍼로 제작되었습니다.{' '}
                  </p>
                </div>
              </div>
