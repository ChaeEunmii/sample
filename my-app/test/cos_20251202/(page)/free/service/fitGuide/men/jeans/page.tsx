...
export default function Page() {
  return (
    <FreeHtml>
      <div className="content-section fit-men-jeans">
              ...
              <div className="contain">
                <div className="richTextSpan">
                  <div className=" text-2cols noPadding">
                    <p />
                    <p>
                      완벽한 커팅과 프리미엄 패브릭이 돋보이는 COS 진 컬렉션. 테이퍼드와 스트레이트 핏부터 모던한 와이드
                      레그 핏까지, 클래식 핏을 재해석한 다양한 스타일을 만나보세요.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="cta-section pb-4 lg:pb-0">
          <div className="m-double-button" style={{ textAlign: 'center' }}>
            <a className="fitguide_btn" href=" https://www.cos.com/ko-kr/men/jeans.html">
              진 쇼핑하기
            </a>{' '}
          </div>
        </div>
        ...
        />
        <div
          className="container-602710 flex flex-col w-full lg:pb-30 pb-20  gap-20 lg:gap-30 manual-cpnt"
          style={{ paddingTop: 36 }}
        >
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row one-column-row  load-more-602710 ">
            {/* o-grid-controller */}
   ...
   "
                ...
                >
                  <picture
                    ...
                    className="a-picture"
                    data-component-id="7179d255-3556-4612-9c53-37f17b707e28"
                  >
                    <img
                      loading="lazy"
                      className="a-image initial loaded"
                      data-src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2854020020250610144829.jpg"
                      src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2854020020250610144829.jpg"
                ...
                <div className="contain">
                  <div className="richTextSpan">
                    ...
                    <div className=" text-2cols">
                      <p />
                      <p>
                        감각적인 데일리 아이템, COS 테이퍼드 진은 다리 전체에 루즈하게 떨어지다가 발목으로 갈수록
                        좁아지는 여유로운 실루엣으로 완성되었습니다. 클래식한 테이퍼드 핏은 남성 컬렉션을 대표하는 주요
                        스타일입니다.
                      </p>
                    </div>
                  </div>
        ...
        <div className="cta-section pb-10 pt-7.5">
          <div className="m-double-button" style={{ textAlign: 'center' }}>
            {/*
<a class="fitguide_btn" href="https://www.cos.com/ko-kr/men/jeans.html">테이퍼드 진 쇼핑하기</a>
*/}
            <a className="fitguide_btn" style={{ border: 'none' }} />
          </div>
        </div>
        <div className="container-602704 flex flex-col w-full lg:pb-30 pb-20  gap-20 lg:gap-30 manual-cpnt">
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row one-column-row  load-more-602704 ">
            {/* o-grid-controller */}
            <div className="grid grid-cols-12 gap-x-3.75 md:gap-x-5 col-span-12 lg:gap-y-10 gap-y-4.5   pt-0 ">
              <div className="column relative col-span-12 w-full h-full lg:col-span-4  lg:col-start-5 lg:col-end-9 ">
                <div
   ...
   "
                ...
                >
                  <picture
                    ...
                    data-component="APicture"
                    className="a-picture"
                    data-component-id="1a392c47-311a-4634-b456-1979d97e8c54"
                  >
                    <img
                      loading="lazy"
                      className="a-image loaded"
                      data-src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2854020020250610144840.jpg"
                      src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2854020020250610144840.jpg"
                      style={{ objectFit: 'cover' }}
                      data-was-processed="true"
                    />
                  </picture>
                  ...
                  <div className="richTextSpan">
                    ...
                    <div className=" text-2cols">
                      ...
                      <p>
                        ...
                        <br />
                        - 다리 라인을 따라 루즈하게 떨어지는 핏<br />
                        <br />- 편안한 착용감을 선사하는 디자인
                      </p>
                    </div>
                    <div className=" text-2cols">
                      <p />
                      <p>
                        와이드 레그 진은 COS 워드로브를 대표하는 시그니처 아이템입니다. 모던한 실루엣으로 디자인되어
                        다리 전체에 루즈하게 떨어지며, 자연스러운 무드를 연출합니다.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container-603036 flex flex-col gap-20 lg:gap-30 w-full lg:pb-30 pb-20 manual-cpnt">
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row four-column-row load-more-603036 ">
            {/* o-grid-controller */}
            <div className="grid grid-cols-12 gap-x-8 md:gap-x-4 col-span-12 lg:gap-y-30 gap-y-10 pt-0 ">
              ...
              >
                ...
                <a
                  ...
                  data-tourl="/ko-kr/men/view-all/product.rider-wide-leg-jeans-dusty-blue.1220422002.html?slitmCd=40A1796201"
                  target="_self"
                ...
                >
                  <div
                    ...
                    data-index={1}
                    data-id={1220422002}
                    data-name="RIDER WIDE-LEG JEANS"
                    data-category="/fitguide/men/jeans-fit-guide"
                    data-color="DUSTY BLUE"
                    data-sellprc={175000}
                    data-csmprc={175000}
                    data-list-name="Men jeans fit guide"
                  ...
                  >
                    <div className="image-holder">
                      <img
                        ...
                        loading="lazy"
                        src="https://image.thehyundai.com/static/0/2/6/79/A1/hnm40A1796201_16_720.jpg"
                        alt="COS image 1 of 더스티 블루 in RIDER 와이드 레그 진"
                      ...
                      <div className="btn_wish_cos btn_wish_plp absolute top-4 right-4 hidden-new">
                        <span
                          data-value="40A1796201"
                          data-slitmcd="40A1796201"
                          className="cta_wish 40A1796201 !min-h-7 !min-w-7"
                    ...
                    <div className="description !py-3 !mt-0">
                      <div className="product-variants">
                        <label className="a-label js-a-label">Colours (8)</label>
                      </div>
...
*/}
              ...
              >
                ...
                <a
                  ...
                  onclick="return startWebGateFromLink(228, this, event)"
                  href="javascript:void(0);"
                  data-tourl="/ko-kr/men/view-all/product.rider-wide-leg-jeans-black.1220422008.html?slitmCd=40A2019436"
                  target="_self"
                  className="a-link no-styling"
                >
                  <div
                  ...
                  >
                    <div className="image-holder">
                      <img
                        className="a-image product-image"
                        loading="lazy"
                        src="https://image.thehyundai.com/static/3/4/9/01/A2/hnm40A2019436_1_720.jpg"
                        alt="COS image 2 of 블랙 in RIDER 와이드 레그 진"
                        onerror="this.src='https://image.thehyundai.com/cos_cdn/images/cos/02/noimg_400.jpg';"
                      />
                      <div className="btn_wish_cos btn_wish_plp absolute top-4 right-4 hidden-new">
                        <span
                          data-value="40A2019436"
                          data-slitmcd="40A2019436"
                          className="cta_wish 40A2019436 !min-h-7 !min-w-7"
                          data-template="wishlistFull-popup"
                          data-classes="js-scrollbar-unbind is-medium"
                        >
                          <div
...
*/}
              ...
              >
                ...
                <a
                  ...
                  onclick="return startWebGateFromLink(228, this, event)"
                  href="javascript:void(0);"
                  data-tourl="/ko-kr/men/view-all/product.rider-selvedge-wide-leg-jeans-raw-indigo.1219886001.html?slitmCd=40A1796199"
                  target="_self"
                  className="a-link no-styling"
                >
                  <div
                    ...
                    data-index={3}
                    data-id={1219886001}
                    data-name="RIDER SELVEDGE WIDE-LEG JEANS"
                    data-category="/fitguide/men/jeans-fit-guide"
                  ...
                  >
                    <div className="image-holder">
                      <img
                        className="a-image product-image"
                        loading="lazy"
                        src="https://image.thehyundai.com/static/9/1/6/79/A1/hnm40A1796199_5_720.jpg"
                        alt="COS image 3 of 로 인디고 in RIDER 셀비지 와이드 레그 진"
                        onerror="this.src='https://image.thehyundai.com/cos_cdn/images/cos/02/noimg_400.jpg';"
                      />
                      <div className="btn_wish_cos btn_wish_plp absolute top-4 right-4 hidden-new">
                        <span
                          data-value="40A1796199"
                          data-slitmcd="40A1796199"
                          className="cta_wish 40A1796199 !min-h-7 !min-w-7"
                          data-template="wishlistFull-popup"
                          data-classes="js-scrollbar-unbind is-medium"
                        >
                          <div
...
*/}
      ...
      <div className="fit-men-jeans">
        ...
        <div className="container-603041 flex flex-col w-full lg:pb-30 pb-20  gap-20 lg:gap-30 manual-cpnt">
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row one-column-row  load-more-603041 ">
            {/* o-grid-controller */}
            <div className="grid grid-cols-12 gap-x-3.75 md:gap-x-5 col-span-12 lg:gap-y-10 gap-y-4.5   pt-0 ">
              <div className="column relative col-span-12 w-full h-full lg:col-span-4  lg:col-start-5 lg:col-end-9 ">
                <div
   ...
   "
                ...
                >
                  <picture
                    ...
                    data-component="APicture"
                    className="a-picture"
                    data-component-id="0fe325e4-7959-4671-ae74-704c715f57e1"
                  >
                    <img
                      loading="lazy"
                      className="a-image loaded"
                      data-src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2854020020250610144853.jpg"
                      src="https://image.thehyundai.com/static/image/sect/hnm/cpnt/hnmmain2854020020250610144853.jpg"
                  ...
                  <div className="richTextSpan">
                    ...
                    <div className=" text-2cols">
                      ...
                      <p>
                        ...
                        - 허벅지를 따라 여유로운 스타일
                        <br />
                        <br />- 발목까지 스트레이트 핏으로 떨어지는 컷
                      </p>
                    </div>
                    <div className=" text-2cols">
                      <p />
                      <p>
                        클래식한 스타일을 모던하게 재해석한 스트레이트 핏 진은 허벅지를 따라 여유롭고 편안한 실루엣으로
                        완성되었습니다. 워드로브의 기본 아이템으로 자리 잡은 스트레이트 핏 진은 유틸리티 디테일로 정제된
                        무드가 더해졌습니다.
                      </p>
                    </div>
                  </div>
        ...
        <div className="container-603042 flex flex-col gap-20 lg:gap-30 w-full lg:pb-30 pb-20 manual-cpnt">
          <div className="u-cols-sm-12-12 u-cols-md-12-12 u-cols-lg-24-24 u-row four-column-row load-more-603042 ">
            {/* o-grid-controller */}
            <div className="grid grid-cols-12 gap-x-8 md:gap-x-4 col-span-12 lg:gap-y-30 gap-y-10 pt-0 ">
              <div
                style={{ marginBottom: '-2px !important' }}
              ...
              >
                ...
                <a
                  ...
                  onclick="return startWebGateFromLink(228, this, event)"
                  href="javascript:void(0);"
                  data-tourl="/ko-kr/product.dome-straight-leg-jeans-light-blue.1209037015.html?slitmCd=40A2030748"
                  target="_self"
                  className="a-link no-styling"
                >
                  <div
                    ...
                    data-index={1}
                    data-id={1209037015}
                    data-name="DOME STRAIGHT-LEG JEANS"
                    data-category="/fitguide/men/jeans-fit-guide"
                  ...
                  >
                    <div className="image-holder">
                      <img
                        ...
                        loading="lazy"
                        src="https://image.thehyundai.com/static/4/7/0/03/A2/hnm40A2030748_1_720.jpg"
                        alt="COS image 1 of 라이트 블루 in DOME 스트레이트 레그 진"
                        onerror="this.src='https://image.thehyundai.com/cos_cdn/images/cos/02/noimg_400.jpg';"
                        data-was-processed="true"
                      />
                      <div className="btn_wish_cos btn_wish_plp absolute top-4 right-4 hidden-new">
                        <span
                          data-value="40A2030748"
                          data-slitmcd="40A2030748"
                          className="cta_wish 40A2030748 !min-h-7 !min-w-7"
                          data-template="wishlistFull-popup"
                          data-classes="js-scrollbar-unbind is-medium"
                        >
                          <div
                    ...
                    <div className="description !py-3 !mt-0">
                      <div className="product-variants">
                        <label className="a-label js-a-label">Colours (13)</label>
                      </div>
                      <div className="mb-1 flex flex-row items-start gap-x-5 justify-between">
                        <label
                          className="a-label js-a-label !mt-0 font_small_xs_regular truncate"
...
*/}
              ...
              >
                ...
                <a
                  ...
                  onclick="return startWebGateFromLink(228, this, event)"
                  href="javascript:void(0);"
                  data-tourl="/ko-kr/men/view-all/product.dome-raw-selvedge-straight-leg-jeans-raw-indigo.1259766001.html?slitmCd=40A2000108"
                  target="_self"
                  className="a-link no-styling"
                >
                  <div
                    ...
                    data-index={2}
                    data-id={1259766001}
                    data-name="DOME RAW SELVEDGE STRAIGHT-LEG JEANS"
                    data-category="/fitguide/men/jeans-fit-guide"
                    data-color="RAW INDIGO"
                    data-sellprc={190000}
                    data-csmprc={190000}
                  ...
                  >
                    <div className="image-holder">
                      <img
                        className="a-image product-image loading"
                        loading="lazy"
                        src="https://image.thehyundai.com/static/0/1/0/00/A2/hnm40A2000108_1_720.jpg"
                        alt="COS image 2 of 로 인디고 in DOME 로 셀비지 스트레이트 레그 진"
                        onerror="this.src='https://image.thehyundai.com/cos_cdn/images/cos/02/noimg_400.jpg';"
                        data-was-processed="true"
                      />
                      <div className="btn_wish_cos btn_wish_plp absolute top-4 right-4 hidden-new">
                        <span
                          data-value="40A2000108"
                          data-slitmcd="40A2000108"
                          className="cta_wish 40A2000108 !min-h-7 !min-w-7"
                          data-template="wishlistFull-popup"
                          data-classes="js-scrollbar-unbind is-medium"
                        >
                          <div
...
*/}
              ...
              >
                ...
                <a
                  ...
                  onclick="return startWebGateFromLink(228, this, event)"
                  href="javascript:void(0);"
                  data-tourl="/ko-kr/men/view-all/product.dome-straight-leg-jeans-black.1209037001.html?slitmCd=40A1794015"
                  target="_self"
                  className="a-link no-styling"
                >
                  <div
                  ...
                  >
                    <div className="image-holder">
                      <img
                        className="a-image product-image loading"
                        loading="lazy"
                        src="https://image.thehyundai.com/static/1/0/4/79/A1/hnm40A1794015_18_720.jpg"
                        alt="COS image 3 of 블랙 in DOME 스트레이트 레그 진"
                        onerror="this.src='https://image.thehyundai.com/cos_cdn/images/cos/02/noimg_400.jpg';"
                        data-was-processed="true"
                      />
                      <div className="btn_wish_cos btn_wish_plp absolute top-4 right-4 hidden-new">
                        <span
                          data-value="40A1794015"
                          data-slitmcd="40A1794015"
                          className="cta_wish 40A1794015 !min-h-7 !min-w-7"
                          data-template="wishlistFull-popup"
                          data-classes="js-scrollbar-unbind is-medium"
                        >
                          <div
