...
import styles from './HistoryOrderGroup.module.scss';

/**
 * '과거주문내역조회' 주문번호 단위 주문 섹션 컴포넌트
...
interface HistoryOrderGroupProps {
  /** 주문번호 단위 데이터 */
...
export function HistoryOrderGroup({ data, mode, onButtonClick }: HistoryOrderGroupProps) {
