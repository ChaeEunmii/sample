...
/** 과거주문내역용 재구성 */
import { OrderItem } from '@/views/mypage/order/history/components';
import type { OrderItemType } from '@/views/mypage/order/history/components/order/OrderItem';
import { OrderStatusFlag } from '@/views/mypage/order/history/components/order/OrderStatusFlag';
import { OrderStatusBtns } from '@/views/mypage/order/history/components/order/OrderStatusBtns';
