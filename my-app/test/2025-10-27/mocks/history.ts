...
// 플래그 우측 날짜 샘플데이터
const mockOrderFlagDate = '2025-10-25T12:34:56';
...
// 클레임_환불정보
export const mockRefundInfoData3 = {
  totalAmount: 123450, // 총 환불금액 직접 지정시
  refundItems: [
    {
      id: 'refund-product',
      label: '환불 상품금액',
...
const mockDefaultInfoTohome = { name: '김*대', phone: ['010-****-5678', '010-****-5678'] }; // 번호 모두 노출케이스(투홈)
...
export const mockDeliveryCase = [
  ...
  },
  {
    ...
    ...mockDefaultAddr,
    addPhone: '010-****-5978', // 추가 연락처(더현대)
    dawnNote: '새벽배송 시 초인종 누르지 말아주세요.', // 새벽배송 요청사항(투홈)
    parcelNote: '택배배송 시 연락 후 배송 부탁드립니다.', // 택배배송 요청사항(투홈)
  },
  {
    ...mockDefaultInfoTohome, // 번호 모두노출(투홈)
    ...mockDefaultAddr,
...
// ---------- 클레임 상품 샘플데이터(취소,반품,교환 상세(L)) ---------- //
export const mockClaimDeliveryData = [
  // 취소상세 상품
  {
    id: 'claim-delivery-01',
    deliveryType: '택배배송',
    sellers: [
      {
        id: 'claim-delivery-01-seller-01',
        // seller: '루고 컴퍼니',
        // arrival: '10월 10일 (금) 새벽배송 도착',
        items: [
          {
            ...
            //   //feePolicy: 'freeOnly', //무료배송
            // },
            id: 'claim-delivery-01-seller-01-item-01',
            orderStatus: {
              status: 'cancelled', //취소완료(주문취소)
              date: mockOrderFlagDate,
            },
          },
        ],
  ...
  // 반품상세 상품
  {
    id: 'claim-delivery-02',
    deliveryType: '택배배송',
    sellers: [
      {
        id: 'claim-delivery-02-seller-01',
        // seller: '루고 컴퍼니',
        // arrival: '10월 10일 (금) 새벽배송 도착',
        items: [
          {
            ...
            //   //feePolicy: 'freeOnly', //무료배송
            // },
            id: 'claim-delivery-02-seller-01-item-01',
            orderStatus: {
              status: 'return_requested', //반품접수
              date: mockOrderFlagDate,
            },
          },
        ],
  ...
  // 교환상세 상품
  {
    id: 'claim-delivery-03',
    deliveryType: '택배배송',
    sellers: [
      {
        id: 'claim-delivery-03-seller-01',
        // seller: '루고 컴퍼니',
        // arrival: '10월 10일 (금) 새벽배송 도착',
        items: [
          {
            ...
            //   //feePolicy: 'freeOnly', //무료배송
            // },
            id: 'claim-delivery-03-seller-01-item-01',
            orderStatus: {
              status: 'exchange_delivery_complete', //교환완료
              date: mockOrderFlagDate,
            },
          },
        ],
...
export const mockCommonOrder = {
  ...
  payment: mockTheHyundaiPayment, // 결제정보_더현대
  paymentTohome: mockTohomePayments, // 결제정보_투홈
  ...
  receiverInfo: mockReceiverInfoData, // 선물 받는분
  ...
  claimRefund: mockRefundInfoData3, // 환불정보__클레임
};
