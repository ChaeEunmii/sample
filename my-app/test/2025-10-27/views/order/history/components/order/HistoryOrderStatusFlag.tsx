...
import styles from './HistoryOrderStatusFlag.module.scss';
import type { OrderStatusCode } from '@/views/mypage/order/history/components/order/HistoryOrderStatus';
...
export const orderStatusMetaMap = {
  ...
  return_requested: { label: '반품접수', color: 'gray4' }, // 반품접수
...
export const HistoryOrderStatusFlag = ({
  status,
  date,
  dateNote,
  note,
    ...
    <div className={styles.root}>
      ...
      {(date || dateNote) && (
        <span className={styles.date}>
          {date && formatDateForDisplay(date)} {dateNote && dateNote}
        </span>
      )}
...
HistoryOrderStatusFlag.displayName = 'HistoryOrderStatusFlag';
