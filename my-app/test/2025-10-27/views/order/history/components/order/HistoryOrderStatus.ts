// types/HistoryOrderStatus.ts

// '과거주문내역조회' 주문 상태 코드 타입 정의 (HistoryOrderStatusFlag, HistoryOrderStatusBtns 컴포넌트에서 사용)
export type OrderStatusCode =
  ...
  | 'exchange_delivery_complete'; // 교환완료

// 주문 케이스 타입 정의 (HistoryOrderStatusBtns 컴포넌트에서 사용)
