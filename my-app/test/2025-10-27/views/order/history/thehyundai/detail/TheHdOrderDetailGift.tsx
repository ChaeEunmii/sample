...
export default function TheHdOrderDetailGift() {
  // mock 데이터 가져오기
  ...
  // 선물하기 오더 샘플 (mockOrderDetailItemsCase)
  const giftOrder = orderData.find((d) => d.id === 'order-detail-holiday') ?? orderData[0];
  ...
  return (
    <Container showBack title="주문 상세 정보">
      <Contents className={styles.layout}>
        ...
        {/* 주문상품 */}
        <HistoryOrderProducts data={[giftOrder]} />
        {/* 배송지 */}
        <HistoryDeliveryDetail title="받으시는 분" data={deliveryAddress[1]} />
        {/* 결제 및 할인정보 */}
