        ...
        return (
          <OrderStatusBtnsPreview
            ...
            statusItems={[
              ...
              { label: '교환진행중', status: 'exchanging_delivering' },
            ]}
          />
        );
      case 'storepick':
        ...
        return (
          <OrderStatusBtnsPreview
            ...
            statusItems={[
              ...
              { label: '상품준비중', status: 'product_ready', orderCase: 'gift' },
      ...
      case 'experience':
        return (
          <OrderStatusBtnsPreview
            baseData={SampleOrder}
            statusItems={[
              { label: '(체험단) 결제완료', status: 'payment_completed', orderCase: 'experience' },
              { label: '(체험단) 상품준비', status: 'product_ready', orderCase: 'experience' },
              { label: '(체험단) 배송중', status: 'delivering', orderCase: 'experience' },
              { label: '(체험단) 배송완료', status: 'delivered', orderCase: 'experience' },
              {
                label: '(0원상품) 결제완료',
                status: 'payment_completed',
                orderCase: 'zeroPrice',
              },
              { label: '(0원상품) 상품준비', status: 'product_ready', orderCase: 'zeroPrice' },
              { label: '(0원상품) 배송중', status: 'delivering', orderCase: 'zeroPrice' },
              { label: '(0원상품) 배송완료', status: 'delivered', orderCase: 'zeroPrice' },
            ]}
          />
        );
      case 'etc':
      ...
      case 'voucherCoupon':
        return (
          <OrderStatusBtnsPreview
            baseData={SampleOrder}
            statusItems={[
              { label: '(이용권) 결제완료', status: 'payment_completed', orderCase: 'voucher' },
              {
                label: '(이용권) 반품접수',
                status: 'return_requested_digital',
                orderCase: 'voucher',
              },
              {
                label: '(이용권) 반품완료',
