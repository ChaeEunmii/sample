    ...
    <Container showBack title="유료멤버십 관리">
      <Contents className={styles.layout}>
        <TitleArea
          topSlot={
            <>
              <Text as="strong" size="5" weight="semibold" indent>
                현재 이용중
              </Text>
            </>
          }
          ...
          bottomSlot={
            <Text size="4" color="gray3" indent>
              2025.07.04~2025.08.03
            </Text>
          }
        />
        <Stack>
          <Text size="8" weight="bold" indent>
            이번달 받으신 혜택을 확인해보세요
          </Text>
        </Stack>
        ...
        {/* 확인해주세요 */}
        <Section title="확인해주세요" variant="collapse" flush marginTop="3" borderTop>
