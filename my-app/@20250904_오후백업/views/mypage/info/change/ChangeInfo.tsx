    ...
    <Container showBack title="회원정보 변경">
      <Contents>
        ...
        <FormArea type="vertical">
          {!isChange ? (
            <>
              <FormItem label="이메일주소">
                <Stack type="field">
                  <Input title="이메일주소" size="large" value="abc****@********" readOnly />
          ...
          <FormItem label="아이디">
            <Input title="아이디" size="large" value="abc****@********" readOnly />
          </FormItem>
          <FormItem label="이름">
            <Input title="이름" size="large" value="김*대" readOnly />
          </FormItem>
          <FormItem label="비밀번호">
            <Button variant="tertiary" size="large">
              변경하기
        ...
        <Section variant="section" title="부가정보" level="1">
          ...
          <FormArea type="vertical">
            <FormItem label="생일">
              <Input size="large" value="2001-12-**" readOnly />
            </FormItem>
            <FormItem
              label="결혼기념일"
              side={
