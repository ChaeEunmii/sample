      ...
      orderStatus: {
        ...
        status: isEnded
          ...
          : isCanceled
            ...
            : 'subscription_active',
        subscription: {
          endDate: '20251225', // 구독종료 시 날짜설정
          cancelDate: '20251225', // 구독해지 시 날짜설정
        },
      },
    },
  ];
  ...
  return (
    <Container showBack title="구독 상세 조회">
      <Contents className={styles.layout}>
        ...
        {/* 배송방법 : 새벽배송 */}
        {!isFinished && (
          <SubscriptionDeliveryMethod data={{ ...mockSubscribeDeliveryMethod, method: 'dawn' }} />
        )}
        {/* 배송방법 : 당일배송 */}
        {!isFinished && (
          <SubscriptionDeliveryMethod data={{ ...mockSubscribeDeliveryMethod, method: 'today' }} />
        )}
        {/* H.Point 사용 */}
