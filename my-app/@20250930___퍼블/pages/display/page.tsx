...
import { mockProdRecommands, mockBrandRecommands, mockKeywords, mockRsvpTabs } from '@mocks/rsvp';
import {
  mockBannerList,
  mockIconBanners,
  ...
  const renderComponent = (component: string | null) => {
    switch (component) {
      ...
      case 'HF_LV_GD_01':
        return (
          <>
            <HF_LV_GD_01 currentLive={mockCurrentLiveTile.live} data={mockLiveTiles} />
            <HF_LV_GD_01
              currentLive={mockCurrentLiveTile.upcoming}
              data={mockLiveTiles}
              margin="6"
            />
            <HF_LV_GD_01 currentLive={mockCurrentLiveTile.ended} data={mockLiveTiles} margin="6" />
          </>
        );
        ...
        return (
          <>
            ...
            <Rsvp_rcmm_01
              ...
              margin="6"
            />
            <Rsvp_rcmm_01 name="김*대" tabs={mockRsvpTabs} products={[]} brands={[]} margin="6" />
          </>
        );
      case 'CO_TP_LI_08':
        return (
          <>
            <CO_TP_LI_08
              ...
              data={mockProdBanner.slice(0, 4)}
              defaultCategoryTab={{ mid: 'mid-1', sub: 'sub-2', det: 'det-3', sort: 'newest' }}
