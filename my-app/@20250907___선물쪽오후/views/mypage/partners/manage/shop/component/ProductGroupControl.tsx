...
import styles from './ProductGroupControl.module.scss';
interface MenuItem {
...
interface ProductGroupControlProps {
  menuItems: MenuItem[];
}

export const ProductGroupControl = ({ menuItems }: ProductGroupControlProps) => {
