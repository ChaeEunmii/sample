...
export const beautyOptions = {
  ...
  skinIssue: {
    ...
    data: [
      ...
      { label: '진정', value: 'skinissue5' },
      { label: '브라이트닝', value: 'skinissue6' },
      { label: '영양', value: 'skinissue7' },
      { label: '피지', value: 'skinissue8' },
      { label: '트러블', value: 'skinissue9' },
      { label: '각질', value: 'skinissue10' },
      { label: '안티에이징', value: 'skinissue11' },
    ],
  },
};
